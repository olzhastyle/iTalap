          ...
          <ul class="carousel__main1">
            <li id="carousel__slide1">
              <div class="carousel-container">
                <img
                  class="avatar147"
                  src="../../assets/aboutus/manap.jpeg"
                  alt=""
                />
                <h2>Шымыр Манап</h2>
                <p class="textabout">
                  Шымыр Манап - "Болашақ" бағдарламасы бойынша Мюнхен техникалық
                  университетінің (Германия) магистранты. Қазақстан даму
                  банкінде стратегия және үлкен деректерді талдау
                  департаментінің бас маманы.
                </p>
                <p class="textabout">
                  “Заманауи технологияның күннен күнге ғарыш жылдамдығымен дамуы
                  және олардың адам өмірінің ажырамас бөлігі болып жатқаны
                  баршаға мәлім. Қазіргі таңда және болашақта заманның даму
                  бағытына ілесу және кез келген саланың білікті маманы болу
                  үшін IT саласын білу қажет. Себебі IT - ақылды тетіктер
                ...
                <a href="#carousel__slide2" class="carousel__next"
                  ><img src="../../assets/navigation/left.png" alt=""
                /></a>
              </div>
            </li>
            <li id="carousel__slide2">
              <div class="carousel-container">
                <img
                  class="avatar147"
                  src="../../assets/aboutus/olzhas.jpg"
                  alt=""
                />
                <h2>Әбдірахман Олжас</h2>
                <p class="textabout">
                  Әбдірахман Олжас - "Ғарыштық инженерия" мамандығының
                  магистранты. Қазақстан ғарыш орталығының инженері, Front-End,
                  android developer.
                </p>
                <p class="textabout">
